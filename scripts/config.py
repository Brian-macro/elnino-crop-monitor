...
SOURCES = {
    ...
    "ec": dict(name="European Commission DG AGRI Production Databases", url="https://agriculture.ec.europa.eu/data-and-analysis/markets/overviews/market-observatories/crops/cereals-statistics_en", freq="monthly", script="fetch_local_sources.py"),
    ...
    "us_nass": dict(name="USDA NASS Crop Production", url="https://esmis.nal.usda.gov/publication/crop-production", freq="monthly", script="fetch_local_sources.py"),
    "uk_defra": dict(name="UK DEFRA Agriculture in the UK", url="https://www.gov.uk/government/collections/agriculture-in-the-united-kingdom", freq="annual", script="fetch_local_sources.py"),
    "mx_siap": dict(name="Mexico SIAP Agricultural Closing Database", url="https://nube.agricultura.gob.mx/cierre_agricola/", freq="annual", script="fetch_local_sources.py"),
    "jp_maff": dict(name="Japan MAFF Statistical Yearbook", url="https://www.maff.go.jp/e/data/stat/", freq="annual", script="fetch_local_sources.py"),
    "ph_psa": dict(name="Philippines PSA OpenSTAT", url="https://openstat.psa.gov.ph/", freq="quarterly", script="fetch_local_sources.py"),
    "my_dosm": dict(name="Malaysia DOSM Open Data", url="https://open.dosm.gov.my/data-catalogue", freq="annual", script="fetch_local_sources.py"),
    "pk_pbs": dict(name="Pakistan Bureau of Statistics", url="https://www.pbs.gov.pk/agriculture-sector-of-pakistan-importance-role-key-statistics/", freq="annual", script="fetch_local_sources.py"),
    "tw_afa": dict(name="Taiwan AFA Open Data", url="https://data.moa.gov.tw/", freq="annual", script="fetch_local_sources.py"),
    "kz_bns": dict(name="Kazakhstan BNS Gross Harvest", url="https://stat.gov.kz/en/industries/business-statistics/stat-forrest-village-hunt-fish/dynamic-tables/", freq="annual", script="fetch_local_sources.py"),
    "china_outlook": dict(
        name="中国农业展望报告",
...
STALE_DAYS = {
    ...
    "us_nass": 65, "uk_defra": 400, "mx_siap": 400, "jp_maff": 400,
    "ph_psa": 120, "my_dosm": 400, "pk_pbs": 400, "tw_afa": 400,
    "kz_bns": 400,
}
BASIS = {
    "wheat": "grain",
