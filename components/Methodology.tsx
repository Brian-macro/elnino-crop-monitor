    ...
    <main className="document">
      ...
      <section>
        ...
        <p>
          ...
          Estimate 表，不能作为当年的历史预测，也不直接冒充最终实产。各国有同目标年、同产品口径的权威产量即优先采用；缺同源上年值只影响同比，不阻止本年替换。上方来源表由实际入库数据和首页选择结果生成，区分数据库入口、已入库范围和所选年度真正采用的来源。中国玉米、大豆、糖优先 CASDE，小麦优先 CropWatch；农业展望长期预测独立保存。
      ...
      <section>
        ...
        <p>
          ...
          Year 是自然年。巴西 CONAB 的 2025/26 作季仍属于起始年2025，不因报告在2026年发布而移到2026/27；乌克兰收获自然年对应同年开始的市场年度，南非夏季收获年对应前一年开始的作季。稻谷 Paddy、精米
          Milled、早稻、冬小麦和未注明折算口径的食糖独立保存，无法匹配时不计算同比、共识或预测误差。
        </p>
        <p>
          Global与地区产量采用本土优先组合：各国按可用本国产量或 PSD 选择，且只在来源与口径可比时计算同比。任一成员缺可比上年值，组合同比留空，产量仍展示；本土覆盖率按本年产量占比计算。存在EU合计时剔除成员，地区研究篮子不重复加回Global。历史复盘默认采用真实产量数据库；PSD/WASDE供需表独立参考，不能把本土产量与USDA库存、消费当成同源供需表。WASDE
          World行仅作对照。共识不参与主序列拼接；对照区要求同年度、同口径、45天内至少两家独立机构，USDA
          PSD/WASDE只算一家。
        </p>
        <p>
          首页“预测同比范围”是两套来源预测同比的范围，不是统计置信区间；“产量缺口”按两套全球预测的产量差额除以基准产量计算。缺口扩大显示红色，收窄显示绿色。
        </p>
      </section>
      <section>
        <h2>气候与研究计算</h2>
